...
if "02_treatment/03_CLEANING(c)" != "" local TRUECRYPT "02_treatment/03_CLEANING(c)"
...
* 01. intro
runcopy, file("01 intro") loc("$DO") back("$DO_B/`dir'") `onlycopy' 

* 02. master
runcopy, file("02_treatment/03_cleaning(c)_02_master") loc("$DO/`dir'") back("$DO_B/`dir'") `onlycopy'

* 
loc ++i
runcopy, file("") loc("$DO/`dir'") back("$DO_B/`dir'") `runcopy'
master_describe_tool `i' 
